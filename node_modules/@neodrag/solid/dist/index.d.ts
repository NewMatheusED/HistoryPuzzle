...
declare const createDraggable: () => {
    draggable: (node: HTMLElement, options: Accessor<DragOptions>) => void;
};

export { DragAxis, DragBounds, DragBoundsCoords, DragEventData, DragOptions, createDraggable };
